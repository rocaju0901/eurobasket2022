...
--
-- Host: localhost    Database: proyecto_grupal
-- ------------------------------------------------------
...
--
-- Table structure for table `partidos_fase`
--

DROP TABLE IF EXISTS `partidos_fase`;
...
--
-- Dumping data for table `partidos_fase`
--

LOCK TABLES `partidos_fase` WRITE;
...
-- Dump completed on 2023-01-02 10:35:38
