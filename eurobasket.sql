/*CREAMOS LA BASE DE DATOS DE EUROBASKET*/
...
CREATE TABLE FASE1(
    ...
    PAIS1 VARCHAR(21) NOT NULL ,
    PAIS2 VARCHAR(21) NOT NULL ,
     PAIS3 VARCHAR(21) NOT NULL ,
     PAIS4 VARCHAR(21) NOT NULL ,
     PAIS5 VARCHAR(21) NOT NULL ,
     PAIS6 VARCHAR(21) NOT NULL

);
/*INSERTAMOS LOS VALORES DE LA TABLA DE LA PRIMERA FASE*/
...
/*CREAMOS LA TABLA DE OCTAVOS DE FINAL*/
...
/*AÑADIMOS LOS VALORES DEL GRUPO DE OCTAVOS DE FINAL*/
INSERT INTO OCTAVOS(GRUPO, PAIS1, PAIS2, PAIS3, PAIS4, PAIS5, PAIS6, PAIS7, PAIS8, PAIS9, PAIS10, PAIS11, PAIS12, PAIS13, PAIS14, PAIS15, PAIS16) VALUES
        ('OCTAVOS','TURQUIA','ESLOVENIA','ALEMANIA','ESPANA','UCRANIA','FINALNDIA',
         'FRANCIA','GRECIA','SERBIA','BELGICA','MONTENEGRO','LITUANIA','POLONIA',
         'CROACIA','ITALIA','REPUBLICA CHECA');
SELECT * FROM OCTAVOS;

/*CREAMOS LA TABLA DE CUARTOS DE FINAL*/
CREATE TABLE CUARTOS(
     GRUPO VARCHAR(21) PRIMARY KEY,
     PAIS1 VARCHAR(21) NOT NULL ,
     PAIS2 VARCHAR(21) NOT NULL ,
     PAIS3 VARCHAR(21) NOT NULL ,
     PAIS4 VARCHAR(21) NOT NULL ,
     PAIS5 VARCHAR(21) NOT NULL ,
     PAIS6 VARCHAR(21) NOT NULL,
     PAIS7 VARCHAR(21) NOT NULL ,
     PAIS8 VARCHAR(21) NOT NULL
);
/*AÑADIMOS LOS VALORES DE LA TABLA DE CUARTOS DE FINAL */
...
/*AÑADIMOS LOS VALORES DE LA TABLA SEMIFINAL*/
INSERT INTO SEMIFINAL(GRUPO, PAIS1, PAIS2, PAIS3, PAIS4) VALUES
            ('CUARTOS','POLONIA','ALEMANIA','ESPANA','FRANCIA');

SELECT * FROM SEMIFINAL;

/*CREAMOS LA TABLA DE LA FINAL*/
CREATE TABLE FINAL(
     GRUPO VARCHAR(21) PRIMARY KEY,
     PAIS1 VARCHAR(21) NOT NULL ,
     PAIS2 VARCHAR(21) NOT NULL
);
/*AÑADIMOS LOS VALORES DE LA TABLA FINAL*/
...
/*CREAMOS LA TABLA DE LOS PARTIDOS JUGADOS EN CADA FASE*/
CREATE TABLE PARTIDOS_FASE(
    grupo     VARCHAR(21) NOT NULL,
    pais1     VARCHAR(21) NOT NULL,
    pais      VARCHAR(21) NOT NULL,
    resultado VARCHAR(21) NOT NULL,
    fecha     DATE NOT NULL ,
    hora      TIME NOT NULL
);
INSERT INTO PARTIDOS_FASE( GRUPO, PAIS1, PAIS, RESULTADO, FECHA, HORA) VALUES
                                ('A','ESPAÑA','BULGARIA','114-87','2022-09-01','15:30'),
                                ('B','BOSNIA Y HERZEGOVINA','HUNGRIA','95-85','2022-09-01','14:30'),
                                ('C','UCRANIA','GRAN BRETAÑA','90-61','2022-09-02','14:15'),
                                ('D','ISRAEL','FINLANDIA','89-97','2022-09-02','14:00');


DROP TABLE PARTIDOS_FASE;

SELECT * FROM PARTIDOS_FASE;
